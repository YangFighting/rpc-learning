 ...
 * @author zhangyang03
 * @Description
 * @create 2024-04-02 15:59
 */
public final class ExtensionLoader<T>  {
    private static final Logger LOG = LoggerFactory.getLogger(ExtensionLoader.class);

    private static final String SERVICES_DIRECTORY = "META-INF/services/";
    private static final String YANG_DIRECTORY = "META-INF/yang/";
    private static final String YANG_DIRECTORY_EXTERNAL = "META-INF/yang/external/";
    private static final String YANG_DIRECTORY_INTERNAL = "META-INF/yang/internal/";

    private static final String[] SPI_DIRECTORIES = new String[]{
            SERVICES_DIRECTORY,
            YANG_DIRECTORY,
            YANG_DIRECTORY_EXTERNAL,
            YANG_DIRECTORY_INTERNAL
    };
